...
-- por lo que la nueva fecha de inicio será el 16/05. Se le solicita modificar la fecha de inicio de esos alumnos.<br>
UPDATE cohorte
...
-- el área de People le solicita un listado de los instructores que dictan la carrera de Full Stack Developer.<br>
...
-- 9. La siguiente consulta permite acceder a datos de otras tablas y devolver
-- un listado con la carrera a la cual pertenece cada alumno:
...
/*Coneste la siguientes interrogantes:
  a. ¿Que campos permiten que se puedan acceder al nombre de la carrera?
	Campo nombre, de la tabla carrera
  b. ¿Que tipo de ralación existe entre el nombre la tabla cohorte y alumno?
		1 - Muchos
  ...
  d. ¿Proponga dos opciones para filtrar el listado solo por los alumnos que
	pertenecen a 'Full Stack Developer', utilizando " = " y " != "?
    ¿Cual de las dos opciones es la manera correcta de hacerlo?, ¿Por que?
