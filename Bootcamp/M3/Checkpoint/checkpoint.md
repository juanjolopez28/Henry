...
<h2>1) La asignación de índices para las tablas en SQL no genera nunguna mejora en la performance de los queries. </h2> -->V
...
--> V
<h2>3) La regla de las 3 sigmas para detección de Outliers está basada en la Mediana. </h2> -->F
<h2>4) Los valores outliers se deben en todos los casos a cargas erróneas de los datos. </h2>-->F
...
<p>2- Sería aduecuado colocar un índice sobre el campo trimestre de la tabla calendario aunque este no sea una clave foránea.</p> ---->CORRECTA
